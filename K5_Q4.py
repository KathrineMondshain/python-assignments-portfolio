'''
Explanation:
There is a triangle with three defined vertices
A starting point is chosen within the triangle
With every iteration, the new point is halfway between the last point and one of the three vertices chosen at random
The result makes the Sierepinski's Triangle fractal which looks kind of crazy and I'm not quite sure why it creates this pattern
'''
